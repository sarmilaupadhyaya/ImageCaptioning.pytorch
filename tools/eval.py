...
def evaluation(model='',cnn_model='resnet101', infos_path='', only_lang_eval=0, force=0,device="cpu"):
    ...
    if only_lang_eval == 1 or (not force and os.path.isfile(pred_fn)): 
...
evaluation(model='/output/image-captioning/model_path/model-best.pth',cnn_model='resnet101', infos_path='output/image-captioning/model_path/infos_fc_nsc-best.pkl', only_lang_eval=0, force=0,device="cpu")   
